...
<body>
	...
	<form method="post" action="auth" id="login">
		...
		<div class="line">
			<h3>Username</h3>
			<input type="text" class="box" required name="user" id="user" placeholder="Enter your username here"/>
		</div>
		<div class="line">
			<h3>Password</h3>
	...
	<div class="create">
		<a href="http://localhost:8080/HospitalManagement/Register.jsp" style="text-decoration: none;">Sign up</a>
