...
<style>
	*{
	...
	body{
		min-height:100vh;
		background-image: url('https://st.depositphotos.com/2945617/3599/v/950/depositphotos_35998423-stock-illustration-doctor-cartoon.jpg');
...
<body>
	...
	%>	
	<div class="container">
	<form method="post" action="adddoctor" class="login" id="login">
		<h1 style="margin-top:20px;">Add Doctor</h1>
		<div class="line">
			<h2>Name</h2>
		...
		<div class="line">
			<h2>Email</h2>
			<input type="email" required class="box" name="email" id="email" placeholder="Enter email id"/>
		</div>
		<div class="line">
			<h2>Specialization</h2>
			<input type="text" required class="box" name="Specialization" id="Specialization" placeholder="Enter Specialization"/>
		</div>
		<div class="line">
			<h2>Experience</h2>
			<input type="number" required class="box" name="experience" id="experience" placeholder="Enter experience"/>
		</div>
		<div class="line">
